...
export const LegalModal: React.FC<LegalModalProps> = ({ isOpen, type, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-navy-950/85 backdrop-blur-xl overflow-y-auto animate-fadeIn">
      <div 
        className="relative w-full max-w-2xl bg-navy-900 border border-white/[0.1] rounded-3xl shadow-2xl overflow-hidden my-8"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="p-6 bg-navy-850 border-b border-white/[0.08] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-blue-500/10 text-cyan-300 flex items-center justify-center border border-blue-500/20">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-xl text-slate-400 hover:text-white bg-white/[0.04] border border-white/[0.06] hover:bg-white/[0.08] transition-colors"
        ...
        <div className="p-6 max-h-[65vh] overflow-y-auto text-slate-300 text-sm leading-relaxed space-y-4">
          {type === 'privacy' && (
            <>
              ...
              <h4 className="text-base font-bold text-white pt-2">1. Information Collection</h4>
              <p>
              ...
              <h4 className="text-base font-bold text-white pt-2">2. How We Use Information</h4>
              <p>
              ...
              <h4 className="text-base font-bold text-white pt-2">3. Data Security</h4>
              <p>
          ...
          {type === 'terms' && (
            <>
              ...
              <h4 className="text-base font-bold text-white pt-2">1. Scope of Services</h4>
              <p>
              ...
              <h4 className="text-base font-bold text-white pt-2">2. Intellectual Property</h4>
              <p>
              ...
              <h4 className="text-base font-bold text-white pt-2">3. Client Responsibilities</h4>
              <p>
          ...
          {type === 'disclaimer' && (
            <>
              ...
              <h4 className="text-base font-bold text-white pt-2">1. Performance Transparency</h4>
              <p>
              ...
              <h4 className="text-base font-bold text-white pt-2">2. Ad Spend & Third-Party Platforms</h4>
              <p>
        ...
        {/* Footer */}
        <div className="p-4 bg-navy-850 border-t border-white/[0.08] flex justify-end">
          <button
            onClick={onClose}
